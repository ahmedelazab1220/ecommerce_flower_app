...
part of 'edit_profile_retrofit_client.dart';
...
class _EditProfileRetrofitClient implements EditProfileRetrofitClient {
  _EditProfileRetrofitClient(this._dio, {this.baseUrl, this.errorLogger}) {
