...
part of 'change_password_retrofit_client.dart';
...
class _ChangePasswordRetrofitClient implements ChangePasswordRetrofitClient {
  _ChangePasswordRetrofitClient(this._dio, {this.baseUrl, this.errorLogger}) {
